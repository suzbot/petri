...
3. **Minimal changes**: Only add/update what the summary warrants. Do not reorganize, rewrite, or "improve" existing content. New guidance must generalize beyond the triggering case.

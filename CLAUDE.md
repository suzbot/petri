...
**Next**: D6 (Preference formation with expanded attributes), D7 (Seeking/avoidance refinements)

Key D5 decisions (Pattern/Texture system):
...
- Mushroom attributes: Pattern (spotted or none), Texture (slimy or none)
- Preference formation: 30% single attribute, 70% combo (2 attributes)

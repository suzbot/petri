...
When the user is ready to plan the next phase:

1. Read the roadmap portion of claude.md to find what the next phase is
2. Read the requirements document for the next phase
3. Provide feedback, ask clarifying questions, compare options with trade-offs for high-level approaches. Phase plan should identify iterative approach with frequent human testing checkpoints.
